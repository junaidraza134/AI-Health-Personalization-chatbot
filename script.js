...
// Health and Diet System Prompt
const HEALTH_DIET_PROMPT = `
You are a health and nutrition expert assistant. Your role is to:
1. Provide accurate information about nutrition, diet, and healthy eating
2. Offer general health advice and wellness tips
3. Suggest healthy recipes and meal plans
4. Explain the benefits of different foods and nutrients
5. Provide exercise recommendations that complement diet

For any questions not related to health, nutrition, or general wellness, respond with:
"I'm specialized in health and nutrition topics. Please ask me about diet, healthy eating, or wellness."

Only answer health-related questions. For all other topics, politely decline.
`;
...
async function generateResponse(aiChatBox) {
  ...
  const fullPrompt = `${HEALTH_DIET_PROMPT}\n\nUser question: ${user.message}`;
  ...
  try {
    ...
    const apiResponse =
      ...
      "⚠️ I couldn't process your health-related question. Please try again.";
